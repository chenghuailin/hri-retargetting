...
MOTION_CAPTURE_G1_INSPIREHANDS_CORRESPONDENCE = [
    ...
    [MOTION_CAPTURE_LINKS.index("RightArm"), G1_INSPIREHANDS_LINKS.index("right_shoulder_roll_link"), 10],
    [MOTION_CAPTURE_LINKS.index("RightForeArm"), G1_INSPIREHANDS_LINKS.index("right_elbow_link"), 10],
    [MOTION_CAPTURE_LINKS.index("RightHand"), G1_INSPIREHANDS_LINKS.index("R_hand_base_link"), 10],
